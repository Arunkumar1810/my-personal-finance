# Capability: Active Trades

## Purpose
Active Trades monitors open swing trading positions, active holdings, pending buy GTT orders, and orphaned sell GTT orders.

## Requirements

### Requirement: Active Trades Organization
The system SHALL provide an Active Trades capability structured into three primary sections: Active Holdings, Pending Buy GTT Orders, and Orphaned Sell GTT Orders.

#### Scenario: User inspects active trades
- **WHEN** the user inspects active trades
- **THEN** three distinct sections are presented: Active Holdings, Pending Buy GTT Orders, and Orphaned Sell GTT Orders.
...
### Requirement: Read-Only Monitoring Mode
The Active Trades capability SHALL be strictly read-only, presenting a pure monitoring environment without forms, action buttons, edit icons, or delete actions.
