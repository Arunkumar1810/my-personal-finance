# Capability: Console Auth

## Purpose
Authenticates with the Zerodha platform to acquire session credentials for Console API requests.

## Requirements

### Requirement: Console Platform Authentication
