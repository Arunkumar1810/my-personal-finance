# Capability: Asset Transactions

## Purpose
Asset Transactions provides a comprehensive, domain-localized chronological ledger of all credit and debit cashflows, capital deployments, and capital realizations for each asset account, serving as the immutable audit trail and computational foundation for dynamic XIRR performance metrics.
