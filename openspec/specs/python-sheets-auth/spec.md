# Capability: python-sheets-auth

## Purpose
TBD - This capability handles the authentication of the Python service with Google Sheets and the reading and writing of data.
