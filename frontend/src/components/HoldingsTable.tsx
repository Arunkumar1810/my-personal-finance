      ...
      <table className="w-full text-sm text-left table-fixed">
        <thead className="text-xs text-neutral-400 uppercase bg-[#2C2C35] border-b border-neutral-700">
          <tr>
            ...
            <th className="px-4 py-2 w-2/12">Stock Name</th>
            <th className="px-4 py-2 text-right w-2/12">Current Price</th>
            <th className="px-4 py-2 text-right w-2/12">Invested Amt</th>
            <th className="px-4 py-2 text-right w-2/12">Current Amt</th>
            <th className="px-4 py-2 text-right w-2/12">P&amp;L</th>
            <th className="px-4 py-2 text-right w-2/12">Day Change</th>
          </tr>
        </thead>
        <tbody>
          {holdings.length === 0 ? (
